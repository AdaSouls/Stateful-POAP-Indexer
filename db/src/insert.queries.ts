...
const createIssuerIR: any = {"usedParamSet":{"issuerId":true,"issuerAddress":true,"username":true,"email":true,"organization":true},"params":[{"name":"issuerId","required":true,"transform":{"type":"scalar"},"locs":[{"a":171,"b":180}]},{"name":"issuerAddress","required":true,"transform":{"type":"scalar"},"locs":[{"a":191,"b":205}]},{"name":"username","required":false,"transform":{"type":"scalar"},"locs":[{"a":211,"b":219}]},{"name":"email","required":false,"transform":{"type":"scalar"},"locs":[{"a":224,"b":229}]},{"name":"organization","required":false,"transform":{"type":"scalar"},"locs":[{"a":234,"b":246}]}],"statement":"INSERT INTO issuers (\n  \"issuerUuid\",\n  \"issuerId\",\n  \"issuerAddress\",\n  username,\n  email,\n  organization,\n  \"createdAt\",\n  \"updatedAt\"\n)\nVALUES (\n  DEFAULT,\n  :issuerId!,\n  lower(:issuerAddress!),\n  :username,\n  :email,\n  :organization,\n  DEFAULT,\n  DEFAULT\n)\nON CONFLICT (\"issuerId\") DO NOTHING\nRETURNING *"};
